		    			...
		    			<tr>
	    					...
	    					<?php  
		    						if ($value->status == 0) { ?>
		    							...
		    							data-id="<?php echo $value->id_list_lelang ?>" 
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" id="modal-data">    
		...
		<div class="form-group row">
			...
			<div class="col-sm-9">
				<input type="number" class="form-control" name="hrg_brg" autocomplete="off" min="0" required>
			</div>
		</div>
		<div class="form-group row">
      ...
      <div class="modal-footer">
        <button type="submit" class="btn btn-primary btn-block">
        	<span class="menu-icon mdi mdi-send"></span> Sending
        </button>
      </div>
	</form>
    </div>
